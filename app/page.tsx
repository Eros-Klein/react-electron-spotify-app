...
export default function Auth() {
  ...
  return (
    <div className="flex flex-col w-screen h-screen justify-evenly items-center overflow-hidden">
        ...
        <Image src="/icon.svg" width={300} height={300} alt="Spotify Logo" className="w-1/3 h-1/3" />
        <button className="bg-primary text-background px-5 py-3 shadow-lg shadow-gray-900 rounded-md transition-all duration-200 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary tracking-wider">Get Started</button>
    </div>
  );
}
